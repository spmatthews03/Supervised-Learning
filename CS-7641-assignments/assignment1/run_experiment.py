...
if __name__ == '__main__':
    ...
    ds1_data = loader.BattingBaseballData(verbose=verbose, seed=seed)
    ds1_name = 'batting_stats'
    ds1_readable_name = 'Batting Stats'
    ds1_data.load_and_process()

    ds2_data = loader.PitchingBaseballData(verbose=verbose, seed=seed)
    ds2_name = 'pitching_stats'
    ds2_readable_name = 'Pitching Stats'
